...
| `GET /api/symbols` | дефолтный топ монет (по обороту 24ч) + добавленные вручную; цены, обороты, ликвидации за 24 ч |
...
- Палитра мелких событий кодирует сторону: ликвидация лонгов —
  **маджента**, шортов — **циан**. Киты от $100K красятся по тепловой шкале
  объёма: **$100K — жёлтый → $300K → $500K → $1M → ярко-красный** ($5M+),
  с тёмной подложкой и светящимся ободком, чтобы читались на свече любого
  цвета. Маркеры-«молнии» 🔥 над/под свечой красятся в тот же тепловой цвет.
...
- **OI-треугольники: куда идут деньги.** У каждой свечи считается изменение
  ...
  мелочь **<$1M — мини-значок без цифр**, $1M+ — подписанный треугольник,
  $5M+ и $20M+ — всё крупнее, ярче (заливка осветляется) и с более сильным
  свечением; слабые при тесноте уступают сильным. В шапке — бокс OI
  по монете графика:
