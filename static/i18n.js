...
(function (global) {
    ...
    var RU = {
        ...
        "filter.th_book": "Стена стакана, $",
        "filter.book_placeholder": "Например 500000",
        "filter.th_short_book": "📖 Стены",
        ...
        "ind.liq_hint": "Столбики: лонги {l} / шорты {s} · кривая: накопленный перевес {acc}",
        "ind.cvd_hint": "Сумма тейкер-дельты по видимым свечам: {net} · кривая — накопление по свечам",
        "ind.oi_hint": "Изменение OI за видимый диапазон · сейчас {last}",
        "ind.oi_nodata": "OI: нет данных по бирже",
        "ind.nodata": "нет данных",
        "gate.min_short": "{min} мин",
        ...
        "modal.book_comp": "Стоит сейчас / снято / съедено:",
        "modal.book_zone": "Зона цены:",
        "modal.book_walls": "Стены в зоне:",
        "modal.book_about": "Стена — плотный уровень лимитных ордеров в стакане (L2). Кластер стоит на свече, где стены нашли: залиты и светятся только те, что стоят в стакане сейчас. Снятая стена оставляет пустоту в своём ценовом коридоре; съеденную (остаток <70% пика) видно красной вспышкой пару секунд — и тоже пустота. Пунктирный контур — где стены были. Не осталось живых — кластер исчезает.",
        ...
        "land.card10.title": "Стены стакана на графике",
        "land.card10.desc": "Крупные лимитные заявки с бирж собираются в кластеры прямо у свечи, где их заметили: живые светятся, снятые оставляют дырку, съеденные вспыхивают красным. Лента «Заявки» и свой порог объёма.",
    ...
    var EN = {
        ...
        "filter.th_book": "Order-book wall, $",
        "filter.book_placeholder": "e.g. 500000",
        "filter.th_short_book": "📖 Walls",
        ...
        "ind.liq_hint": "Bars: longs {l} / shorts {s} · curve: cumulative imbalance {acc}",
        "ind.cvd_hint": "Taker delta over visible candles: {net} · curve — cumulative by candle",
        "ind.oi_hint": "OI change over the visible range · now {last}",
        "ind.oi_nodata": "OI: no data from the exchange",
        "ind.nodata": "no data",
        "gate.min_short": "{min} min",
        ...
        "modal.book_comp": "Live now / pulled / eaten:",
        "modal.book_zone": "Price zone:",
        "modal.book_walls": "Walls in zone:",
        "modal.book_about": "A wall is a dense L2 limit-order level. The cluster sits on the candle where its walls were found; only walls that are in the book right now are filled and glowing. A pulled wall leaves a hole at its price range; an eaten one (<70% of peak left) flashes red for a couple of seconds, then becomes a hole too. The dotted outline marks where walls used to be. No live walls left — the cluster disappears.",
        ...
        "land.card10.title": "Order-book walls on the chart",
        "land.card10.desc": "Large resting limit orders from the exchanges are clustered right at the candle where they appeared: live walls glow, pulled ones leave a hole, eaten ones flash red. An «Orders» tape and your own volume threshold.",
    ...
    var ZH = {
        ...
        "filter.th_book": "盘口墙，$",
        "filter.book_placeholder": "例如 500000",
        "filter.th_short_book": "📖 墙",
        ...
        "chart.book": "📖 盘口",
        "chart.book_on": "隐藏盘口限价墙",
        "chart.book_off": "显示盘口限价墙：大额挂单(L2)价位处的簇",
        "chart.pane_liq": "💥 清算窗口",
        "ind.liq_hint": "柱：多头 {l} / 空头 {s} · 曲线：累计失衡 {acc}",
        "ind.cvd_hint": "可见K线的主动成交差：{net} · 曲线 — 按K线累计",
        "ind.oi_hint": "可见范围内 OI 变化 · 当前 {last}",
        "ind.oi_nodata": "OI：交易所无数据",
        "ind.nodata": "暂无数据",
        "gate.min_short": "{min} 分钟",
        ...
        "modal.book_comp": "当前在挂 / 已撤 / 被吃：",
        "modal.book_zone": "价格区间：",
        "modal.book_walls": "区间内的墙：",
        "modal.book_about": "墙 = 盘口(L2)中密集的限价单档位。簇钉在发现它的K线上，只有此刻仍在盘口的墙才填色发光。撤单的墙在其价格区间留下空洞；被吃掉的（剩余<70%峰值）红色闪烁数秒后同样变成空洞。虚线轮廓标出墙曾经的位置。没有活墙时簇消失。",
        ...
        "land.card10.title": "图上的盘口墙",
        "land.card10.desc": "交易所的大额限价挂单在被发现的那根K线上聚成簇：在挂的发光，撤掉的留下空洞，被吃掉的闪红。附带「挂单」流水和自定义成交量阈值。",
        "land.card9.cta": "免费注册",
        "land.how.title": "工作原理",
    ...
    var HI = {
        ...
        "filter.th_book": "ऑर्डर-बुक वॉल, $",
        "filter.book_placeholder": "जैसे 500000",
        "filter.th_short_book": "📖 दीवारें",
        ...
        "chart.book": "📖 बुक",
        "chart.book_on": "ऑर्डर-बुक की दीवारें छिपाएँ",
        "chart.book_off": "ऑर्डर-बुक की दीवारें दिखाएँ: बड़े लिमिट ऑर्डरों (L2) के दाम पर क्लस्टर",
        "chart.pane_liq": "💥 LIQ विंडो",
        "ind.liq_hint": "बार: लॉन्ग {l} / शॉर्ट {s} · वक्र: संचित असंतुलन {acc}",
        "ind.cvd_hint": "दिख रही कैंडलों पर टेकर डेल्टा: {net} · वक्र — कैंडल-दर-कैंडल संचय",
        "ind.oi_hint": "दिख रही रेंज में OI बदलाव · अभी {last}",
        "ind.oi_nodata": "OI: एक्सचेंज से डेटा नहीं",
        "ind.nodata": "डेटा नहीं",
        "gate.min_short": "{min} मिनट",
        ...
        "modal.book_comp": "अभी खड़ी / हटी / खाई गई:",
        "modal.book_zone": "प्राइस ज़ोन:",
        "modal.book_walls": "ज़ोन में दीवारें:",
        "modal.book_about": "दीवार = L2 बुक में लिमिट ऑर्डरों का घना स्तर। क्लस्टर उस कैंडल पर टिका है जहाँ दीवारें मिलीं; सिर्फ़ वही भरी और चमकती हैं जो अभी बुक में हैं। हटाई गई दीवार अपने प्राइस-रेंज में छेद छोड़ती है; खाई गई (<70% बचा) कुछ सेकंड लाल चमकती है और फिर छेद। बिंदीदार रेखा — जहाँ दीवारें थीं। ज़िंदा न बचे — क्लस्टर गायब।",
        ...
        "land.card10.title": "चार्ट पर ऑर्डर-बुक की दीवारें",
        "land.card10.desc": "एक्सचेंजों के बड़े लिमिट ऑर्डर उसी कैंडल पर क्लस्टर बनते हैं जहाँ दिखे: ज़िंदा चमकते हैं, हटाए गए छेद छोड़ते हैं, खाए गए लाल चमकते हैं। «ऑर्डर» टेप और अपनी वॉल्यूम सीमा।",
    ...
    var ES = {
        ...
        "filter.th_book": "Muro del libro, $",
        "filter.book_placeholder": "p. ej. 500000",
        "filter.th_short_book": "📖 Muros",
        ...
        "chart.book": "📖 Libro",
        "chart.book_on": "Ocultar muros del libro de órdenes",
        "chart.book_off": "Mostrar muros del libro: clústeres en los precios de grandes órdenes límite (L2)",
        "chart.pane_liq": "💥 Panel LIQ",
        "ind.liq_hint": "Barras: largos {l} / cortos {s} · curva: desequilibrio acumulado {acc}",
        "ind.cvd_hint": "Delta taker en las velas visibles: {net} · curva — acumulado por vela",
        "ind.oi_hint": "Cambio de OI en el rango visible · ahora {last}",
        "ind.oi_nodata": "OI: sin datos del exchange",
        "ind.nodata": "sin datos",
        "gate.min_short": "{min} min",
        ...
        "modal.book_comp": "Vivo ahora / retirado / comido:",
        "modal.book_zone": "Zona de precio:",
        "modal.book_walls": "Muros en la zona:",
        "modal.book_about": "Un muro es un nivel denso de órdenes límite en el libro L2. El clúster queda en la vela donde se hallaron sus muros; solo los que siguen en el libro ahora están rellenos y brillan. Un muro retirado deja un hueco en su rango de precio; uno comido (<70% del pico) parpadea en rojo unos segundos y también se vuelve hueco. El contorno punteado marca dónde estuvieron. Sin muros vivos, el clúster desaparece.",
        ...
        "land.card10.title": "Muros del libro en el gráfico",
        "land.card10.desc": "Las grandes órdenes límite de los exchanges se agrupan en la vela donde aparecieron: las vivas brillan, las retiradas dejan un hueco, las comidas parpadean en rojo. Cinta «Órdenes» y umbral de volumen propio.",
    ...
    function apply(root) {
        ...
        if (og) og.setAttribute("content", (LOCALE_TAGS[current] || "ru-RU").replace("-", "_"));
