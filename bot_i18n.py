...
сервиса. Пока выбора нет, язык подсказывает Telegram (локаль клиента: русская
— русский, любая другая — язык по умолчанию, английский), а если и подсказки
нет, работает ``DEFAULT_LANG`` — английский. Переводится ВСЁ, что человек
видит в боте — меню, экраны, сигналы алертов, отчёты, подписи кнопок, — а не
только заголовки: иначе русские слова вылезали бы в английском интерфейсе.
...
#: Язык по умолчанию: его видят те, кому Telegram не подсказал русский
#: (клиент на английском, немецком, испанском…) и кто ещё не нажимал «🌐».
#: Английский, а не русский: аудитория канала международная, а переключиться
#: на русский — одна кнопка в меню.
DEFAULT_LANG = "en"
...
def normalize_lang(value: Any) -> str:
    """«en-US» → «en», «ru-RU» → «ru», всё остальное → язык по умолчанию.

    Бот двуязычный, а языков в Telegram много. Русский узнаём по коду
    (``ru``, ``ru-RU``, ``be`` не в счёт), английский — по ``en*``, а любой
    третий (немецкий, испанский, украинский, пустая строка) показываем на
    языке по умолчанию — сейчас это английский: гостю из любой страны он
    понятнее русского, а переключиться на русский — одна кнопка в меню.
    """
