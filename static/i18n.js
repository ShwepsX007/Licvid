...
(function (global) {
    ...
    var RU = {
        ...
        "chart.follow_on": "Автоследование включено: свеча не уходит за край, цена всегда в поле зрения. Нажмите, чтобы выключить",
        "chart.follow_off": "Автоследование выключено: график стоит на месте. Нажмите, чтобы включить",
        "chart.follow_paused": "График отлистан в историю — автоследование на паузе. Нажмите, чтобы вернуться к цене",
    ...
    var EN = {
        ...
        "chart.follow_on": "Auto-follow is on: the candle stays off the edge and the price is always in view. Click to turn it off",
        "chart.follow_off": "Auto-follow is off: the chart stays where you put it. Click to turn it on",
        "chart.follow_paused": "You scrolled into history — auto-follow is paused. Click to jump back to the price",
    ...
    var ZH = {
        ...
        "chart.follow_on": "自动跟随已开启：K线不会跑出边缘，价格始终可见。点击关闭",
        "chart.follow_off": "自动跟随已关闭：图表保持不动。点击开启",
        "chart.follow_paused": "你已翻到历史K线——自动跟随已暂停。点击回到当前价格",
        "chart.liq_label": "爆仓",
    ...
    var HI = {
        ...
        "chart.follow_on": "ऑटो-फ़ॉलो चालू: कैंडल किनारे से बाहर नहीं जाती, कीमत हमेशा दिखती है। बंद करने के लिए दबाएँ",
        "chart.follow_off": "ऑटो-फ़ॉलो बंद: चार्ट अपनी जगह रहता है। चालू करने के लिए दबाएँ",
        "chart.follow_paused": "आप इतिहास में स्क्रॉल कर गए — ऑटो-फ़ॉलो रुका हुआ है। कीमत पर लौटने के लिए दबाएँ",
    ...
    var ES = {
        ...
        "chart.follow_paused": "Te has desplazado al historial: el seguimiento está en pausa. Pulsa para volver al precio",
