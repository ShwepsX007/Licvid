...
(function (global) {
    ...
    var RU = {
        ...
        "modal.book_comp": "Состав по статусам:",
        "modal.book_zone": "Зона цены:",
        "modal.book_walls": "Стены в зоне:",
        "modal.book_about": "Стена — плотный уровень лимитных ордеров в стакане (L2). Плашка стоит на той свече, где стену нашли: живёт там, пока её не уберут или не исполнят. Полосы внутри — профиль по USDT: зелёная — живые, красная — съеденные (остаток <70% пика), серая — ушедшие.",
    ...
    var EN = {
        ...
        "modal.book_comp": "By status:",
        "modal.book_zone": "Price zone:",
        "modal.book_walls": "Walls in zone:",
        "modal.book_about": "A wall is a dense L2 limit-order level. The plate sits on the candle where the wall was found and stays until it is pulled or filled. The inner bands are a USDT profile: green = live, red = eaten (<70% of peak left), gray = gone.",
    ...
    var ZH = {
        ...
        "modal.book_comp": "按状态构成：",
        "modal.book_zone": "价格区间：",
        "modal.book_walls": "区间内的墙：",
        "modal.book_about": "墙 = 盘口(L2)中密集的限价单档位。色块钉在发现它的那根K线上，直到撤单或成交。内部横条是按USDT分布的微型构成：绿色在挂、红色被吃（剩余<70%峰值）、灰色已撤。",
    ...
    var HI = {
        ...
        "modal.book_comp": "स्थिति के अनुसार:",
        "modal.book_zone": "प्राइस ज़ोन:",
        "modal.book_walls": "ज़ोन में दीवारें:",
        "modal.book_about": "दीवार = L2 बुक में लिमिट ऑर्डरों का घना स्तर। प्लेट उसी कैंडल पर टिकी रहती है जहाँ दीवार मिली — जब तक हटाई या फुल न हो जाए। अंदर की पट्टियाँ USDT प्रोफ़ाइल हैं: हरा = ज़िंदा, लाल = खाई गई (<70% बचा), ग्रे = हटी।",
    ...
    var ES = {
        ...
        "modal.book_comp": "Por estado:",
        "modal.book_zone": "Zona de precio:",
        "modal.book_walls": "Muros en la zona:",
        "modal.book_about": "Un muro es un nivel denso de órdenes límite en el libro L2. La placa queda en la vela donde se encontró y permanece hasta que la retiran o la ejecutan. Las bandas internas son un perfil USDT: verde = viva, rojo = comida (<70% del pico), gris = fuera.",
