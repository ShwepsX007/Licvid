...
- **Попап кнопок слоёв.** Тумблеры «⚡ Ликвидации», «🎯 CVD», «● OI» живут
  в выезжающей сверху горизонтальной панели — её открывает заметная кнопка
  «☰ Слои» (размером с «Профиль»). Закрытие: повторный клик, клик мимо,
  Esc. Кнопка «📊 Профиль» осталась в плашке на своём месте.
