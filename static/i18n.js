...
(function (global) {
    ...
    var RU = {
        ...
        "chart.liq_on": "Скрыть шарики ликвидаций с графика",
        "chart.liq_off": "Показать шарики ликвидаций на графике",
        "chart.cvd": "🎯 CVD",
        "chart.cvd_on": "Скрыть CVD-стрелки (перевес покупок/продаж в свече)",
        "chart.cvd_off": "Показать CVD-стрелки: ▲ покупателей, ▼ продавцов в каждой свече",
        ...
        "land.card2.desc": "Живые свечи 1м–4ч, а каждая ликвидация рисуется шариком точно в своей цене: маджента — лонги, циан — шорты, золото — киты от $100K.",
    ...
    var EN = {
        ...
        "chart.liq_on": "Hide liquidation bubbles from the chart",
        "chart.liq_off": "Show liquidation bubbles on the chart",
        "chart.cvd": "🎯 CVD",
        "chart.cvd_on": "Hide CVD arrows (taker buy/sell imbalance per candle)",
        "chart.cvd_off": "Show CVD arrows: ▲ buyers vs ▼ sellers in each candle",
        ...
        "land.card2.desc": "Live 1m–4h candles; each liquidation is drawn as a dot at its exact price: magenta — longs, cyan — shorts, gold — whales from $100K.",
    ...
    var ZH = {
        ...
        "chart.liq": "⚡ 清算",
        "chart.liq_on": "隐藏图表上的清算气泡",
        "chart.liq_off": "在图表上显示清算气泡",
        "chart.cvd": "🎯 CVD",
        "chart.cvd_on": "隐藏 CVD 箭头（每根K线的主动买/卖差）",
        "chart.cvd_off": "显示 CVD 箭头：▲ 主动买方，▼ 主动卖方",
        ...
        "land.card2.desc": "1分钟–4小时实时K线；每次爆仓按精确价格绘制圆点：洋红 — 多单，青色 — 空单，金色 — $100K 以上大户。",
    ...
    var HI = {
        ...
        "chart.liq_on": "चार्ट से लिक्विडेशन बबल छिपाएँ",
        "chart.liq_off": "चार्ट पर लिक्विडेशन बबल दिखाएँ",
        "chart.cvd": "🎯 CVD",
        "chart.cvd_on": "CVD तीर छिपाएँ (कैंडल में खरीद/बिक्री का अंतर)",
        "chart.cvd_off": "CVD तीर दिखाएँ: हर कैंडल में ▲ खरीदार, ▼ विक्रेता",
        ...
        "land.card2.desc": "लाइव 1मि–4घं कैंडल; हर लिक्विडेशन अपनी सटीक कीमत पर बिंदु के रूप में: मैजेंटा — लॉन्ग, सियान — शॉर्ट, गोल्ड — $100K से व्हेल।",
    ...
    var ES = {
        ...
        "chart.liq_on": "Ocultar burbujas de liquidación del gráfico",
        "chart.liq_off": "Mostrar burbujas de liquidación en el gráfico",
        "chart.cvd": "🎯 CVD",
        "chart.cvd_on": "Ocultar flechas CVD (desequilibrio compra/venta por vela)",
        "chart.cvd_off": "Mostrar flechas CVD: ▲ compradores vs ▼ vendedores en cada vela",
        ...
        "land.card2.desc": "Velas en vivo de 1m–4h; cada liquidación se dibuja como un punto en su precio exacto: magenta — longs, cian — shorts, oro — ballenas desde $100K.",
