...
POLL_SEC = float(os.getenv("LIQSCOPE_BOOK_POLL_SEC", "3.0"))
...
# Bybit/OKX, 300 у Gate (его потолок), опрос раз в 3 с и не более 10 монет.
...
MAX_SYMBOLS = int(os.getenv("LIQSCOPE_BOOK_MAX_SYMBOLS", "10"))   # монет в опросе
...
class BookFeed:
    ...
    def status_summary(self):
        ...
        now = time.time()
        out = {"mode": mode, "symbols": self.wanted_symbols(), "poll_sec": self.poll_sec,
