...
- **Окно фигуры: наведи на треугольник или шарик.** Наведение на фигуру CVD/OI
  открывает попап с разбором свечи: направление, подписанная сумма, сила
  относительно p90 (у CVD), тир с порогом в масштабе монеты (у OI), движение
  цены за свечу и строка-пояснение. Активная фигура подсвечивается белым
  кольцом. Клик закрепляет окно (димминг): висит, пока не кликнешь по фигуре
  повторно, мимо неё или по крестику, — как закреп подсветки у прямоугольников.
  Смена монеты или выключение слоя окно закрывает.
